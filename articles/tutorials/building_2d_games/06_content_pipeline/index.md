...
| ![Figure 6-1: MonoGame for VSCode extension icon](./images/mgcb-editor-icon.png) |
| :---: |
| **Figure 6-1: MonoGame for VSCode extension icon** |
...
| ![Figure 6-2: MonoGame Content Builder Editor (MGCB Editor) Window](./images/mgcb-editor.png) |
| :---: |
| **Figure 6-2: MonoGame Content Builder Editor (MGCB Editor) Window** |
...
| ![Figure 6-3: Add existing file pop-up](./images/add-file-popup.png) |
| :---: |
| **Figure 6-3: Add existing file pop-up** |
...
| ![Figure 6-4: New file pop-up](./images/new-file-popup.png) |
| :---: |
| **Figure 6-4: New file pop-up** |
...
| ![Figure 6-5: New folder pop-up](./images/new-folder-popup.png) |
| :---: |
| **Figure 6-5: New folder pop-up** |
...
| ![Figure 6-6: MonoGame Horizontal Logo](./images/logo.png) |
| :---: |
| **Figure 6-6: MonoGame Horizontal Logo** |
...
With the MonoGame logo image now added to the content project, we can load it in our game and draw it.  Open the *Game1.cs* file and perform the following:

1. Add a new [**Texture2D**](xref:xref:Microsoft.Xna.Framework.Graphics.Texture2D) field to store the logo texture in once we load it:

    [!code-csharp[](./snippets/game1/fields.cs?highlight=9-10)]

2. In [**LoadContent**](xref:xref:Microsoft.Xna.Framework.Game.LoadContent), load the logo texture using the [**ContentManager**](xref:Microsoft.Xna.Framework.Content.ContentManager):

    [!code-csharp[](./snippets/game1/loadcontent.cs?highlight=5-6)]
...
| ![Figure 6-7: The MonoGame logo drawn to the game window](./images/logo-drawn.png) |
| :---: |
| **Figure 6-7: The MonoGame logo drawn to the game window** |
